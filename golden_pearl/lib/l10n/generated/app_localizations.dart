...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Free shipping on orders over SAR 560'**
  ...
  /// No description provided for @handcrafted.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @deliveryToAddress.
  ///
  /// In en, this message translates to:
  /// **'Deliver to Address'**
